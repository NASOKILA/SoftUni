namespace SimpleMvc.Framework.Controllers
{
    ...
    public abstract class Controller
    {
        ...
        {
            this.Model["loggedIn"] = this.User.IsAuthenticated ? "block" : "none";

            this.Model["anonymous"] = this.User.IsAuthenticated ? "none" : "block";

            this.Model["message"] = this.User.IsAuthenticated 
                    ? $"Welcome {this.User.Name}"
                    : $"Welcome to Fluffy Duffy Munchkin Cats";
        }
