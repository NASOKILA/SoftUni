...
-- Slagame Idto na klienta i namirame obshtiq balans

select
dbo.f_CalculateTotalBalance(1)
AS Balance
GO
...
GO
--Chrez procedurata dobavqme akaunt s 3, 1 @ClientId, @AccountTypeId
p_AddAccount 3, 1;
...
--Pri kakvat oi da e promqna na Accounts se dobavq informaciq v Transactions
