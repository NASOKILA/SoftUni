        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentMethod_BankAccount",
                        column: x => x.BankAccountId,
                        principalTable: "BankAccounts",
                        principalColumn: "BankAccountId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentMethod_CreditCard",
                        column: x => x.CreditCardId,
                        principalTable: "CreditCards",
                        principalColumn: "CreditCardId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentMethod_User",
                        column: x => x.UserId,
            ...
            //Tuk si dobavqme check constrainta:
            migrationBuilder.Sql("ALTER TABLE PaymentMethods ADD CONSTRAINT " + 
                                 "CK_CreditCardId_BankAccountId CHECK( " + 
                                 "(CreditCardId IS NOT NULL AND BankAccountId IS NULL) OR " +
