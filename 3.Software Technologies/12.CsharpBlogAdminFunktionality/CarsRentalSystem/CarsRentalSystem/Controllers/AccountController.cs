...
using CarsRentalSystem.Models;
using CarsRentalSystem.DataModels;
using CarsRentalSystem.Models.Renting;
...
namespace CarsRentalSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Rentings() {
            ...
            var rentings = db.Rentings      // Vzimame kolite ot bazata obache ot rentings, vzimame tezi na koito userId suvpada
                .Where(r => r.UserId == userId)
                .OrderByDescending(r => r.Id) // podrejdame gi po Id
