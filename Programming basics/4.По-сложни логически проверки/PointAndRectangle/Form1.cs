...
namespace PointAndRectangle
{
    public partial class FormPointAndRectangle : Form
    {
        ...
        {
            // load izvikva se pri startirane na prilojenieto oshte predi da izleze glavnata forma na ekrana
            Draw();
        }
        ...
        {
            // vkluchva se pri natiskane na butona
            Draw();
        ...
        {
            //rerise izvikva se pri promqna na razmere na glavnata forma
            Draw();
        }
